...
export const ForkIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.375v5.25m0 0l-2.25-2.25M12.75 8.625l2.25-2.25M3.375 12.75h17.25M3.375 12.75c0-4.01 3.24-7.25 7.25-7.25s7.25 3.24 7.25 7.25m-14.5 0c0 4.01 3.24 7.25 7.25 7.25s7.25-3.24 7.25-7.25" />
    </svg>
);
...
export const ChatBubbleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.372A5.56 5.56 0 005.11 21.5a.75.75 0 01-1.07-.022L1.07 18.45a.75.75 0 01.022-1.07l3.528-3.528A9.76 9.76 0 013 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
  </svg>
);
